...
const ThemeSwitcher = () => {
    ...
    return (
        <div>
            <button onClick={HandleTheme} type="button" className=" sticky p-2 text-gray-500 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-900 focus:outline-none focus:ring-4 focus:ring-gray-200 dark:focus:ring-gray-700 rounded-lg text-sm" >
                {theme === 'dark' ? (
